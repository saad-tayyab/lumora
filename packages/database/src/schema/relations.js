...
import { accounts, journalEntries, journalEntryLines, fiscalYears, } from './financial/schema';
import { customers, invoices, invoiceLineItems, payments, paymentApplications, creditNotes, } from './ar/schema';
import { vendors, bills, billLineItems, vendorPayments, paymentSchedules, } from './ap/schema';
import { bankAccounts, bankTransfers, bankStatements, reconciliationEntries, currencies, bankConnections, } from './cash/schema';
import { unitOfMeasures, itemCategories, items, warehouses, stockLevels, stockMovements, } from './inv/schema';
import { purchaseOrders, poLineItems, receivingReports, vendorCatalogItems, } from './proc/schema';
import { salesOrders, salesOrderLineItems, quotations, quotationLineItems, discountPolicies, } from './sales/schema';
import { departments, designations, employees, attendance, leaveTypes, leaveRequests, salaries, payroll, payslips, } from './hr/schema';
import { users, roles, userRoles, sessions, credentials, oauthProviders, mfaConfig, permissions, } from './auth/schema';
import { assetCategories, fixedAssets, depreciationSchedules, depreciationEntries, assetAdjustments, } from './asset/schema';
import { taxCodes, taxRates, taxAutoAssignmentRules, } from './tax/schema';
import { budgetHeaders, budgetLines, budgetConsumptions, } from './budget/schema';
import { auditLogEntries } from './audit/schema';
import { reportTemplates, reports, reportSchedules, reportExports, dashboards, kpis, dataSources, } from './report/schema';
import { workflows, workflowSteps, trainingData, aiModels, predictions, anomalyDetections, } from './ai/schema';
