import { boolean, decimal, index, integer, pgEnum, pgTable, timestamp, unique, uniqueIndex, uuid, varchar, } from 'drizzle-orm/pg-core';
...
export const unitOfMeasures = pgTable('unit_of_measures', {
    ...
    baseUomId: uuid('base_uom_id').references(() => unitOfMeasures.id),
...
export const itemCategories = pgTable('item_categories', {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Drizzle self-referencing FK requires any
    parentId: uuid('parent_id').references(() => itemCategories.id),
