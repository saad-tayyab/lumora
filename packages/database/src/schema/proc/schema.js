import { date, decimal, index, integer, pgEnum, pgTable, text, timestamp, uniqueIndex, uuid, varchar, } from 'drizzle-orm/pg-core';
...
export const vendorCatalogItems = pgTable('vendor_catalog_items', {
    ...auditFields,
    ...softDeleteFields,
    vendorId: uuid('vendor_id').notNull().references(() => vendors.id),
