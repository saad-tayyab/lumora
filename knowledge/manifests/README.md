...
Metadata catalogs that index all knowledge artifacts. Manifests enable discovery, validation, and tooling.
...
*Standards: See `STANDARDS.md` for format specifications.*
