...
<div class="mx-auto max-w-4xl space-y-6">
	...
	{#if data.department}
		...
		<Card>
			<CardContent>
				<h2 class="mb-4 text-lg font-semibold text-card-foreground">Department Details</h2>
				<dl class="space-y-3">
...
{#if showDeleteConfirm}
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
		<div class="mx-4 w-full max-w-sm rounded-lg bg-card p-6 shadow-lg">
			<h3 class="text-lg font-semibold text-card-foreground">Delete Department</h3>
